...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2016 at 07:06 PM
...
(3, 3, '2016-05-09', '06:25:07', 'Surat', 1);
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `notifschedule` ON SCHEDULE EVERY 1 DAY STARTS '2016-07-23 22:33:00' ON COMPLETION NOT PRESERVE ENABLE DO update meeting set flag=1 where CURDATE()>=Date$$
